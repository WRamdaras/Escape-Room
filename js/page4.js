...
let textLines = [
   { speed: speeds.slow, string: "I arrived, my revenge will be sweet!" },
   { speed: speeds.pause, string: "", pause: true },
   { speed: speeds.normal, string: "Attack!" },
   { speed: speeds.normal, string: "(Find a button to defeat Zeus!)" }
];
...
let button = document.querySelector('button2'); // Assumes element with id='button'
